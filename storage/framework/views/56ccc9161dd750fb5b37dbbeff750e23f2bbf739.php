            ...
            <ul class="flex flex-wrap list-none pl-0 mb-0">
              ...
              <li class=" relative">
                ...
                <div class=" absolute left-0 z-50 float-left hidden list-reset	 py-2 mt-1 text-base bg-white border border-gray-300 rounded ms-5">
                  <a  class="block w-full py-1 px-6 font-normal text-gray-900 whitespace-no-wrap border-0 text-gray-900" href="<?php echo e(route('maintainence')); ?>">
                    <p>Maintainence</p>
                  </a>

                  <a  class="block w-full py-1 px-6 font-normal text-gray-900 whitespace-no-wrap border-0 text-gray-900" href="<?php echo e(route('scheduled_maintainence')); ?>">
                    <p>Scheduled Maintainence</p>
                  </a>
                  
                  <a  class="block w-full py-1 px-6 font-normal text-gray-900 whitespace-no-wrap border-0 text-gray-900" href="<?php echo e(route('to_do_list')); ?>">
                    <p>To Do List</p>
                  </a>
                </div>
              </li>
              ...
              <li class=" relative">
                ...
                <div class=" absolute left-0 z-50 float-left hidden list-reset	 py-2 mt-1 text-base bg-white border border-gray-300 rounded ms-5">
                  <a class="block w-full py-1 px-6 font-normal text-gray-900 whitespace-no-wrap border-0 text-gray-900" href="<?php echo e(route('student')); ?>" >Students</a>

                  <a class="block w-full py-1 px-6 font-normal text-gray-900 whitespace-no-wrap border-0 text-gray-900" href="<?php echo e(route('parent')); ?>">Parents</a>
                  
                  <a class="block w-full py-1 px-6 font-normal text-gray-900 whitespace-no-wrap border-0 text-gray-900" href="<?php echo e(route('student_parent')); ?>">All Details</a>
                </div>
              </li>
              <li><a class="inline-block py-2 px-4 no-underline" href="<?php echo e(route('siblingslist')); ?>">Siblings List</a></li>
              <?php endif; ?>
              ...
              <li class=" relative">
                ...
                <div class=" absolute left-0 z-50 float-left hidden list-reset	 py-2 mt-1 text-base bg-white border border-gray-300 rounded ms-5">
                  ...
                  <a class="block w-full py-1 px-6 font-normal text-gray-900 whitespace-no-wrap border-0 text-gray-900" href="<?php echo e(route('staff')); ?>">Staffs</a>
                  <?php endif; ?>
                  <a class="block w-full py-1 px-6 font-normal text-gray-900 whitespace-no-wrap border-0 text-gray-900" href="<?php echo e(route('leave')); ?>">Staff Leaves</a>
                </div>
              </li>
