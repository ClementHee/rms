    ...
    <form id="form2" class=" p-4 shadow-lg  bg-white border border-secondary rounded" <?php echo e($mode=="view_single"?'readonly':''); ?> >
        ...
        <div class="row">
            <div class="mb-3  col">
                ...
                <input type="number" <?php echo e($mode=="view_single"?'readonly':''); ?> id="entry_year" name="entry_year" required class="form-control" placeholder="Entry Year" wire:model="entry_year"> 
            </div>
            ...
            <div class="mb-3 form-group col">
                ...
                <input type="date"<?php echo e($mode=="view_single"?'disabled':''); ?> id="enrolment_date" name="enrolment_date" required class="form-control" placeholder="Date Enrolled" wire:model="enrolment_date"> 
            </div>
        </div>
        <div class="row">  
            <div class="mb-3 form-group col">
                <label for="first_name">First Name:</label>
                <input type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> id="first_name" name="first_name" required class="form-control" placeholder="First Name" wire:model="first_name"> 
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3 form-group col ">
                ...
                <input type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> id="last_name" name="last_name" required class="form-control" placeholder="Last Name" wire:model="last_name"> 
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3 form-group col ">
                ...
                <input type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> id="chinese_name" name="chinese_name" required class="form-control" placeholder="Chinese Name (if any)" wire:model="chinese_name"> 
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3 form-group col ">
                ...
                <input type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> id="relationship_w_child" name="relationship_w_child" required class="form-control" placeholder="Relationship With Child" wire:model="relationship_w_child"> 
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class='row'>
            <div class="mb-3 form-group col">
                ...
                <input type="date"<?php echo e($mode=="view_single"?'disabled':''); ?> id="dob" name="dob" required class="form-control pb-2" wire:model="dob">
                <?php $__errorArgs = ['dob'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3 form-group col">
                ...
                <input type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> id="birth_cert_no" name="birth_cert_no" required class="form-control pb-2" placeholder="Birth Cert" wire:model="birth_cert_no">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3 form-group col">
                ...
                <input type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> id="mykid" name="mykid" required class="form-control pb-2" placeholder="MyKid" wire:model="mykid">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3 form-group col">
                ...
                <input type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> id="pos_in_family" name="pos_in_family" required class="form-control pb-2" placeholder="Position in Family" wire:model="pos_in_family">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="row">
            <div class="mb-3 form-group col">
                ...
                <input type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> id="race" name="race" required class="form-control pb-2" placeholder="Race" wire:model="race">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3 form-group col">
                ...
                <input type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> id="nationality" name="nationality" required class="form-control pb-2" placeholder="Nationality" wire:model="nationality">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3 form-group col">
                ...
                <input type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> id="religion" name="religion" required class="form-control pb-2" placeholder="Religion" wire:model="religion">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-3 form-group">
            ...
            <input type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> id="home_add" name="home_add" required class="form-control pb-2" placeholder="Home Address" wire:model="home_add">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="row">
            <div class="mb-3 form-group col">
                ...
                <input type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> id="home_add" name="poscode" required class="form-control pb-2" placeholder="Poscode" wire:model="poscode">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3 form-group col">
                ...
                <input type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> id="district" name="district" required class="form-control pb-2" placeholder="District" wire:model="district">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3 form-group col">
                ...
                <input type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> id="state" name="state" required class="form-control pb-2" placeholder="State" wire:model="state" default="Sarawak">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3 form-group col">
                ...
                <input type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> id="home_add" name="home_add" required class="form-control pb-2" placeholder="Country" wire:model="country">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class='row'>
            ...
            <div class="mb-3 form-group col">
                ...
                <input type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> id="home_lang" name="home_lang" required class="form-control pb-2" placeholder="Home Language" wire:model="home_lang">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3 form-group col">
                ...
                <input type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> id="religion" name="home_tel" required class="form-control pb-2" placeholder="Home Telephone" wire:model="home_tel">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class='row'>
            <div class="mb-3 form-group col">
                ...
                <input type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> id="prev_kindy" name="prev_kindy" class="form-control pb-2" placeholder="If Any" wire:model="prev_kindy">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3 form-group col">
                ...
                <input type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> id="no_years" name="no_years"  class="form-control pb-2" placeholder="No of Years" value="0" wire:model="no_years">
        ...
        <div class="row">
            <div class="mb-3 col form-group">
                ...
                <div class="mb-3 form-group col">
                    ...
                    <input type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> id="referral_other" name="referral_other"  class="form-control pb-2"  wire:model="referral_other">
        ...
        <div class ="search-box">
            <div class='row'>
                <div class="mb-3 form-group col">
                    ...
                    <input required type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> id="father" name="father" wire:keyup="searchResult_Father" class="form-control" placeholder="Father's name" wire:model="father">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-3 form-group col">
                    ...
                    <input required type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> id="mother" name="mother" wire:keyup="searchResult_Mother" class="form-control pb-2" placeholder="Mother's name" wire:model="mother">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="row">
            <div class="mb-3 form-group col">
                ...
                <input type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> id="e_contact" name="e_contact" required class="form-control pb-2" placeholder="Name" wire:model="e_contact">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3 form-group col">
                ...
                <input required type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> id="e_contact_hp" name="e_contact_hp" required class="form-control pb-2" placeholder="Emergency Contact Number" wire:model="e_contact_hp">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="row">
            <div class="mb-3 form-group col">
                ...
                <input type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> id="e_contact2" name="e_contact2" required class="form-control pb-2" placeholder="Name" wire:model="e_contact2">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3 form-group col">
                ...
                <input required type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> id="e_contact2_hp" name="e_contact2_hp" required class="form-control pb-2" placeholder="Emergency Contact Number" wire:model="e_contact2_hp">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class='row'>
            <div class="mb-3 form-group col">
                ...
                <input type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> id="fam_doc" name="fam_doc"  class="form-control pb-2" placeholder="Family Doctor" wire:model="fam_doc">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3 form-group col">
                ...
                <input type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> id="fam_doc_hp" name="fam_doc_hp"  class="form-control pb-2" placeholder="Family Doctor Tel" wire:model="fam_doc_hp">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3 form-group col">
                ...
                <input type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> id="allergies" name="allergies" class="form-control pb-2" placeholder="Allergies" wire:model="allergies">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-3 form-group col">
            ...
            <input type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> id="carplate" name="carplate"  class="form-control pb-2" placeholder="Carplate number followed by model" wire:model="carplate">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-3 form-group col ">
            ...
            <input type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> id="others" name="others"  class="form-control pb-2" placeholder="Other information" wire:model="others">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-3 form-group">
            ...
            <input type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> id="potential" name="potential"  class="form-control pb-2" placeholder="Name and birthdate" wire:model="potential">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class='row'>
            <div class="mb-3 form-group col">
                ...
                <input type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> id="j1_class" name="j1_class"  class="form-control pb-2" placeholder="Class" wire:model="j1_class">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3 form-group col">
                ...
                <input type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> id="j2_class" name="j2_class"  class="form-control pb-2"  placeholder="Class" wire:model="j2_class">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3 form-group col">
                ...
                <input type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> id="j3_class" name="j3_class"  class="form-control pb-2"  placeholder="Class" wire:model="j3_class">
                <?php $__errorArgs = ['j1_class'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class='row'>
            <div class="mb-3 form-group col">
                ...
                <input type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> id="aft_j1_class" name="aft_j1_class"  class="form-control pb-2"  placeholder="Class" wire:model="aft_j1_class">
                <?php $__errorArgs = ['j1_class'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3 form-group col">
                ...
                <input type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> id="aft_j2_class" name="aft_j2_class"  class="form-control pb-2"  placeholder="Class" wire:model="aft_j2_class">
                <?php $__errorArgs = ['j1_class'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3 form-group col">
                ...
                <input type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> id="aft_j3_class" name="j1_class"  class="form-control pb-2"  placeholder="Class" wire:model="aft_j3_class">
                <?php $__errorArgs = ['j1_class'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
        ...
        <div class="modal-content">
            ...
            <form >
                <div class="modal-body">
                    <div class="mb-3">
                        <label>Name</label>
                        <input required type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> wire:model="name" class="form-control">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input required type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> wire:model="ic_no" class="form-control">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input required type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> wire:model="occupation" class="form-control">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input required type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> wire:model="company_name" class="form-control">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input required type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> wire:model="company_add" class="form-control">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        <label>Tel no</label>
                        <input required type="text" <?php echo e($mode=="view_single"?'readonly':''); ?> wire:model="tel" class="form-control">
                        <?php $__errorArgs = ['tel'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
